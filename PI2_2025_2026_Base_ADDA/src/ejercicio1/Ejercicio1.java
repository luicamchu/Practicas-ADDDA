...
public class Ejercicio1 {
	/*1. Dado un árbol binario de enteros distintos de 0, determine el camino del árbol desde la
	raíz a una hoja no vacía tal que el producto de sus etiquetas sea máximo.
	...
	public static List<Integer> caminoMaximo (BinaryTree<Integer> tree) {
		...
		case BTree(Integer value, var left, var right) -> {
			...
			// 2. Cálculo del producto 
			// Usamos 1 para inicializar el producto y multiplicar por todos los elementos 
			// de la lista.
