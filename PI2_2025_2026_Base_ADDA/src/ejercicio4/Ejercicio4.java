...
public class Ejercicio4 {
	...
	//	4. Se tiene un grafo en el que las aristas son calles y los vértices son intersecciones entre
	//	calles. De cada arista se conoce la duración y el esfuerzo asociados con recorrer dicha
	//	calle a pie. De cada vértice se conoce si alberga o no un monumento de interés, y en caso
	//	de que sí, cuál es el nombre y la relevancia de dicho monumento (valor entero en [0,5)).
	//	Se está preparando una visita guiada por dichos monumentos para un grupo de alumnos
	//	de primaria, en la cual el desplazamiento entre los distintos monumentos se llevará a cabo
	//	a pie.

	//	a) ¿Cuál es el camino de menor duración para ir de un monumento a otro dados?
	//	Muestre el grafo configurando su apariencia de forma que se resalten los caminos.
	...
	//	c) Dado un conjunto de calles cortadas al paso, determinar si se pueden seguir
	//	visitando todos los monumentos a pie comenzando en uno cualquiera de ellos. En
	//	caso contrario, determinar cuál es el conjunto de monumentos a visitar si se deben
	//	elegir los monumentos conectados entre sí que maximice la suma total de las
	//	relevancias. Muestre el grafo configurando su apariencia de forma que se resalten
	//	dichos monumentos.
