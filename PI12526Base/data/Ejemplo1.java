...
public class Ejemplo1 {
	...
	//METODO PUBLICO, NO OLVIDAR PONER EN EL EXAMEN
	public static Map<Cuadrante, Double> solucionRecursivaFinal(List<Punto2D> ls) {
		//return recFinal(0, new HashMap<>(), ls);
		Integer e = 0;
		Map<Cuadrante, Double> ac = new HashMap<>();
		return recFinal(e, ac, ls);
	}
	
	//METODO PRIVADO
	//SE LE PASAN TANTOS PARAMETROS COMO VARIABLES HABIA FUERA DEL WHILE.
	...
	//UNA VEZ QUE LO TENEMOS EN RECURSIVO FINAL PASARLO A ITERATIVO ES AUTOMATICO
